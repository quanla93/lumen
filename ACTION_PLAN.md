...
**Next**: nothing immediate — v0.5.0 closes the Phase 7 first slice end-to-end including docs. v0.6.0 picks up either Cold tier (if demand surfaces for >7d metrics queries) or multi-user / TOTP 2FA / Grafana spike, depending on which the operator hits first.
